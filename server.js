...
//the information is sent to the server in json format. the server cannot understand the incoming format, the server can understand the javascript object, and the incoming request needs to be converted into the javascript object. that is what body-parser is used for.
